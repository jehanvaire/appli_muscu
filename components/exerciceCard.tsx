    ...
    if (isBreak) {
        return (
            <View style={styles.exerciceCard}>
                ...
                <Text style={styles.secondes}>{currentTime}</Text>
                <View
                    style={[
                        styles.btnWrapper,
                        {
        ...
        return (
            <View style={styles.exerciceCard}>
                ...
                <Text
                    style={styles.nom}>{exercice.nom} : {exercice.nbSeries} série{exercice.nbSeries > 1 ? 's' : null}</Text>
                <View>
                    <Text style={styles.series}>{currentSerie} / {exercice.nbSeries}</Text>
                </View>
